#!/usr/bin/env bash
# install.sh — instala a skill schematize-ruby no projeto atual (Claude Code).
#
...
# Como funciona: copia o corpo da skill para .claude/skills/schematize-ruby/ e instala os
...
# Saída: .claude/skills/schematize-ruby/ e .claude/commands/<slug>-*.md no alvo.
set -euo pipefail

SKILL_NAME="schematize-ruby"
