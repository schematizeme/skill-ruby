...
| `/ruby-qa` | fluxo de Q.A. plan-first (§22.9): planeja, gera MD, pede aprovação, roda |
...
- **Fluxo de Q.A. (plan-first, §22.9):** toda submissão de Q.A. **planeja tudo primeiro**, gera um MD detalhado, e **pede aprovação antes de executar**. Nada de Q.A. às cegas.
